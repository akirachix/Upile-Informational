...
const PartnerLogo = () => {
  return (
    ...
    <div className="flex flex-wrap  justify-center items-center mt-24 mb-[10px] gap-2 2xl:justify-between">
      {partnerLogos.map((logo, index) => (
        <Image
          key={index}
          src={logo.src}
          alt={logo.alt}
          className='w-72 h-40 ml-18 mx-4 mb-4 sm:w-[100px] md:w-96 lg:w-40 xl:w-72 sm:h-52 md:h-64 lg:h-40 xl:h-64 2xl:w-96 2xl:h-96 sm:mx-2 sm:mb-2 rounded-[40px]' 
          width={900}
          height={300} 
/>
      ))}
